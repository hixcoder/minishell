...
#    Updated: 2022/08/06 12:18:16 by hboumahd         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
PARSING_FILES  = parse.c quotes.c ft_split2.c utiles.c expand.c expand_2.c ft_strreplace.c tokenize.c ft_split3.c
